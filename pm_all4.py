...
pages = [
    ('funnel.html',     {'prices':['2,000','4,000'], 'extra': lambda h: 'hero-bg' in h and 'funnel-hero.png' in h}),
    ('outbound.html',   {'prices':['4,000','6,000'], 'extra': lambda h: 'hero-bg' in h and 'outbound-hero.png' in h}),
    ('reputation.html', {'prices':['1,500','3,000'], 'extra': lambda h: 'hero-bg' in h and 'reputation-hero.png' in h}),
    ('creative.html',   {'prices':['1,500','3,000'], 'extra': lambda h: 'hero-bg' in h and 'creative-hero.png' in h}),
]
